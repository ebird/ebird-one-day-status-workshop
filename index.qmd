...
The contents of this website comprise the notes for a workshop on best practices for using [eBird](https://ebird.org/home) data and [eBird Status](https://science.ebird.org/en/status-and-trends) data products presented at the [Ornithological Congress of The Americas (OCA)](https://oca2023.com.br/evento/oca2023/home) in August 2023 in Gramado, Brazil. The workshop is divided into two lessons covering:
