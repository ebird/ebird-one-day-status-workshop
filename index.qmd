...
4. [Create an RStudio project](https://support.posit.co/hc/en-us/articles/200526207-Using-RStudio-Projects) for working through the examples in this workshop.
...
Create a script named "ebird-status.R", visit [this link](https://raw.githubusercontent.com/ebird/ebirdst-one-day-status-workshop/main/scripts/ebird-status.R), and copy the contents into the script you just created.
