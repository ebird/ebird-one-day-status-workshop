...
Create a script named "ebird-status.R", visit [this link](https://raw.githubusercontent.com/ebird/ebird-one-day-status-workshop/main/scripts/ebird-status.R), and copy the contents into the script you just created.
